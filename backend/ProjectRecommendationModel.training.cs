...
namespace Backend
{
    public partial class ProjectRecommendationModel
    {
        public const string RetrainFilePath =  @"C:\Users\User\Desktop\ProHive\backend\project_ratings.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"ProjectId",inputColumnName:@"ProjectId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"Rating",MatrixColumnIndexColumnName=@"UserId",MatrixRowIndexColumnName=@"ProjectId",ApproximationRank=14,LearningRate=0.4103118196011283,NumberOfIterations=94,Quiet=true}))      
                                    .Append(mlContext.Transforms.Conversion.MapKeyToValue(outputColumnName:@"UserId",inputColumnName:@"UserId"))      
                                    .Append(mlContext.Transforms.Conversion.MapKeyToValue(outputColumnName:@"ProjectId",inputColumnName:@"ProjectId"));
