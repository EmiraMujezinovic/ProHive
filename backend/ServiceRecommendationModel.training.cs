...
namespace Backend
{
    public partial class ServiceRecommendationModel
    {
        public const string RetrainFilePath =  @"C:\Users\User\Desktop\ProHive\backend\service_ratings.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"ServiceId",inputColumnName:@"ServiceId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"Rating",MatrixColumnIndexColumnName=@"UserId",MatrixRowIndexColumnName=@"ServiceId",ApproximationRank=44,LearningRate=0.4298215362271063,NumberOfIterations=4,Quiet=true}))      
                                    .Append(mlContext.Transforms.Conversion.MapKeyToValue(outputColumnName:@"UserId",inputColumnName:@"UserId"))      
                                    .Append(mlContext.Transforms.Conversion.MapKeyToValue(outputColumnName:@"ServiceId",inputColumnName:@"ServiceId"));
